...
1. **Check the changelog and releases**  
   Review the [Vivid changelog](https://github.com/Vonage/vivid-3/blob/main/libs/components/CHANGELOG.md) and [GitHub releases](https://github.com/Vonage/vivid-3/releases) before upgrading to see what’s changed and whether the update is major or minor. If the update is a major one, breaking changes are always clearly explained there and in the [migration guides](https://apps.vivid.vonage.com/guides/v4-release-migration/).
2. **Update the package**
   Use our official packages which are actively maintained and [kept up to date with every Vivid release](https://apps.vivid.vonage.com/getting-started/vue/#complete-and-up-to-date).
...
- Using our [ESLint plugin](https://apps.vivid.vonage.com/guides/eslint-plugin/) to catch common issues and mistakes when working with Vivid Vue.
...
- [Vivid documentation](https://apps.vivid.vonage.com/)
