...
<div class="wrapper">
	<h1 class="tight">heading-1</h1>
	<h2 class="tight">heading-2</h2>
	<h3 class="tight">heading-3</h3>
	<h4 class="tight">heading-4</h4>
	<h5 class="tight">heading-5</h5>
	<h6 class="tight">heading-6</h6>
	<p>paragraph</p>
	<b>bold</b>
