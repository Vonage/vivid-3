			...
			<div class="${CBD_ACTIONS}" slot="main">
				...
				<vwc-action-group appearance="ghost" style="direction: rtl;" slot="main">
					...
					<vwc-tooltip text="Edit code" placement="top">
						<vwc-button slot="anchor" id="buttonEdit${index}" connotation="cta" aria-label="Edit source code" icon="compose-line" aria-expanded="false" aria-controls="${CBD_CODE_BLOCK}-${index}" onclick="codeBlockButtonClick(this)"></vwc-button>
					</vwc-tooltip>
