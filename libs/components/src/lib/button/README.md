...
<template>
	<VButton label="Button as a link" href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a" target="_blank" icon-trailing appearance="filled" connotation="cta">
		<template #icon><VIcon name="chevron-right-line" /></template>
	</VButton>
</template>
```
...
<template>
	<VButton aria-label="Mute" appearance="outlined">
		<template #icon
			><VIcon>
...
<template>
	<div class="container">
		<VButton class="button" dropdown-indicator appearance="outlined-light" label="Aligned to start content" />
		<VButton class="button button-center" dropdown-indicator appearance="outlined-light" label="Centered content" />
	</div>
</template>
