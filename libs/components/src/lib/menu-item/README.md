	...
	<VMenu open aria-label="Example menu">
		<VMenuItem text="Copy" icon="copy-line">
			<template #kbd-shortcut>
				<VKbdShortcut>
					<VKbdKey name="Control" appearance="dropshadow" size="condensed" />
					<VKbdKey name="C" appearance="dropshadow" size="condensed" />
				</VKbdShortcut>
			</template>
		</VMenuItem>
		<VMenuItem text="Paste" icon="paste-line">
			<template #kbd-shortcut>
				<VKbdShortcut>
					<VKbdKey name="Control" appearance="dropshadow" size="condensed" />
					<VKbdKey name="V" appearance="dropshadow" size="condensed" />
				</VKbdShortcut>
			</template>
		</VMenuItem>
	</VMenu>
...
<vwc-menu open aria-label="Example menu">
	<vwc-menu-item text="Copy" icon="copy-line">
		<vwc-kbd-shortcut slot="kbd-shortcut">
			<vwc-kbd-key name="Control" appearance="dropshadow" size="condensed"></vwc-kbd-key>
