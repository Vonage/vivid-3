...
A common practice used in apps / frameworks to promote a Combobox component to top other elements z-axis, is to utilise a service that dynamically appends a Combobox component to the end of the body element, when called for.

This helps ensure elements don't render over top a Combobox undesirebly.