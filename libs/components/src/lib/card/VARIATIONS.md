...
<template>
	<VCard headline="Vivid Card as a Link" subtitle="Clicking on this card will navigate you to the documentation homepage" href="https://apps.vivid.vonage.com" target="_blank"> </VCard>
</template>
```
...
```html preview
<vwc-card headline="Vivid Card as a Link" subtitle="Clicking on this card will navigate you to the documentation homepage" href="https://apps.vivid.vonage.com" target="_blank"> </vwc-card>
```
