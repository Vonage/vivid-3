...
<your-prefix-empty-state icon="phone-number-line" headline="No numbers"> You do not have any numbers yet. </your-prefix-empty-state>
```
...
<template>
	<VEmptyState icon="check-solid">No results match your search criteria.</VEmptyState>
</template>
```
...
```vue preview
<script setup lang="ts">
import { VEmptyState, VButton } from '@vonage/vivid-vue';
</script>
