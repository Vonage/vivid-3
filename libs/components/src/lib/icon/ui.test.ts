...
<vwc-icon size="3" label="Hand waving">
    ...
    <vwc-layout gutters="small"><div><table>
	<thead>
		<tr>
			<th>Size</th>
	...
	<tbody>
		<tr>
			...
			<td>16px</td>
			<td>
				<vwc-icon name="close-line" size="-6" label="-6 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>-5</td>
			<td>20px</td>
			<td>
				<vwc-icon name="close-line" size="-5" label="-5 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>-4</td>
			<td>24px</td>
			<td>
				<vwc-icon name="close-line" size="-4" label="-4 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>-3</td>
			<td>28px</td>
			<td>
				<vwc-icon name="close-line" size="-3" label="-3 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>-2</td>
			<td>32px</td>
			<td>
				<vwc-icon name="close-line" size="-2" label="-2 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>-1</td>
			<td>36px</td>
			<td>
				<vwc-icon name="close-line" size="-1" label="-1 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>0</td>
			<td>40px</td>
			<td>
				<vwc-icon name="close-line" size="0" label="0 example"></vwc-icon>
			</td>
		</tr>
		<tr>
			<td>1</td>
...
<style>
    ...
    <vwc-layout gutters="small"><div><ul>
	<li>
		<vwc-icon name="heart-solid" connotation="accent" label="accent example"></vwc-icon>
		accent
	</li>
	<li>
		<vwc-icon name="heart-solid" connotation="announcement" label="announcement example"></vwc-icon>
		announcement
	</li>
	<li>
		<vwc-icon name="heart-solid" connotation="cta" label="cta example"></vwc-icon>
		cta
	</li>
	<li>
		<vwc-icon name="heart-solid" connotation="success" label="success example"></vwc-icon>
		success
	</li>
	<li>
		<vwc-icon name="heart-solid" connotation="warning" label="warning example"></vwc-icon>
		warning
	</li>
	<li>
		<vwc-icon name="heart-solid" connotation="alert" label="alert example"></vwc-icon>
		alert
	</li>
	<li>
		<vwc-icon name="heart-solid" connotation="information" label="information example"></vwc-icon>
		information
	</li>
</ul>
...
import { VIcon } from '@vonage/vivid-vue';
    ...
    <vwc-layout gutters="small"><div><vwc-icon name="close-line" class="small-icon"></vwc-icon>
30px
...
<style>
    ...
    <vwc-layout gutters="small"><div><vwc-icon class="icon" name="heart-solid"></vwc-icon>
