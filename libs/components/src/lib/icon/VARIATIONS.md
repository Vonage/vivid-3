...
<template>
	<VIcon name="heart-solid" label="Like" />
</template>
```
...
```html preview
<vwc-icon name="heart-solid" label="Like"></vwc-icon>
```
...
<template>
	<VIcon size="3" label="Hand waving">
	...
	<table>
		...
		<tbody>
			<tr>
				...
				<td>16px</td>
				<td>
					<VIcon name="close-line" size="-6" label="-6 example" />
				</td>
			</tr>
			<tr>
				<td>-5</td>
				<td>20px</td>
				<td>
					<VIcon name="close-line" size="-5" label="-5 example" />
				</td>
			</tr>
			<tr>
				<td>-4</td>
				<td>24px</td>
				<td>
					<VIcon name="close-line" size="-4" label="-4 example" />
				</td>
			</tr>
			<tr>
				<td>-3</td>
				<td>28px</td>
				<td>
					<VIcon name="close-line" size="-3" label="-3 example" />
				</td>
			</tr>
			<tr>
				<td>-2</td>
				<td>32px</td>
				<td>
					<VIcon name="close-line" size="-2" label="-2 example" />
				</td>
			</tr>
			<tr>
				<td>-1</td>
				<td>36px</td>
				<td>
					<VIcon name="close-line" size="-1" label="-1 example" />
				</td>
			</tr>
			<tr>
				<td>0</td>
				<td>40px</td>
				<td>
					<VIcon name="close-line" size="0" label="0 example" />
				</td>
			</tr>
			<tr>
				<td>1</td>
...
<template>
	<ul>
		<li>
			<VIcon name="heart-solid" connotation="accent" label="accent example" />
			accent
		</li>
		<li>
			<VIcon name="heart-solid" connotation="announcement" label="announcement example" />
			announcement
		</li>
		<li>
			<VIcon name="heart-solid" connotation="cta" label="cta example" />
			cta
		</li>
		<li>
			<VIcon name="heart-solid" connotation="success" label="success example" />
			success
		</li>
		<li>
			<VIcon name="heart-solid" connotation="warning" label="warning example" />
			warning
		</li>
		<li>
			<VIcon name="heart-solid" connotation="alert" label="alert example" />
			alert
		</li>
		<li>
			<VIcon name="heart-solid" connotation="information" label="information example" />
			information
		</li>
	</ul>
</template>
