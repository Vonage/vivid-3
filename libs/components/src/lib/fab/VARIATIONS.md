...
<template>
	<VFab label="Add Action">
		<template #icon>
			<VIcon name="plus-line" />
		</template>
	</VFab>
	<VFab icon-trailing label="icon-trailing">
		<template #icon>
			<VIcon name="cart-line" />
		</template>
	</VFab>
...
<template>
	<VFab disabled>
		<template #icon>
			<VIcon name="store-line" label="Home" />
		</template>
	</VFab>
</template>
```
