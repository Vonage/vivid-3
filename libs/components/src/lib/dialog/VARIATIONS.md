...
<template>
	<VDialog headline="Keep Your Project Up to Date with Vivid" subtitle="Why Staying Up to Date with Vivid Packages Matters" scrollable-body open>
		...
		<template #action-items>
			<VButton appearance="filled" label="Read full article" href="https://apps.vivid.vonage.com/whats-new/why-staying-up-to-date-with-vivid-packages-matters/" target="_blank" icon-trailing>
...
<vwc-dialog headline="Keep Your Project Up to Date with Vivid" subtitle="Why Staying Up to Date with Vivid Packages Matters" scrollable-body open>
	...
	<vwc-button slot="action-items" appearance="filled" label="Read full article" href="https://apps.vivid.vonage.com/whats-new/why-staying-up-to-date-with-vivid-packages-matters/" target="_blank" icon-trailing>
