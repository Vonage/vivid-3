...
export class ListboxElement extends Listbox {
	 ...
	 *
	 * @param _ - the previous active index
	 ...
	 * @internal
	 */
	protected checkFirstOption(preserveChecked = false): void {
		if (preserveChecked) {
	 ...
	 * @internal
	 */
	protected checkLastOption(preserveChecked = false): void {
		if (preserveChecked) {
			if (this.rangeStartIndex === -1) {
	 ...
	 * @internal
	 */
	protected checkNextOption(preserveChecked = false): void {
		if (preserveChecked) {
			if (this.rangeStartIndex === -1) {
				this.rangeStartIndex = this.activeIndex;
			}
	 ...
	 * @internal
	 */
	protected checkPreviousOption(preserveChecked = false): void {
		if (preserveChecked) {
			if (this.rangeStartIndex === -1) {
				this.rangeStartIndex = this.activeIndex;
			}
	 ...
	 * @internal
	 */
	protected sizeChanged(_: number | unknown, next: number): void {
