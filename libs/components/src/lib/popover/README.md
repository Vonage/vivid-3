...
| **condensed**                 | `boolean`                                                                                                                                                               | Applies condensed layout with smaller paddings and gaps.                                                                |
...
| **placement**                 | `left-start`, `left-center` `left-end`, `right-start`, `right-center`, `right-end`, `top-start`, `top-center`, `top-end`, `bottom-start`, `bottom-center`, `bottom-end` | Controls the position of the Popover, relative to its anchor element.                                                   |
