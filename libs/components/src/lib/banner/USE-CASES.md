...
import { VBanner, VButton, VHeader, VIcon } from '@vonage/vivid-vue';
</script>
...
<template>
	<div class="site">
		<VBanner class="banner" text="Use Vivid in Your Design" connotation="announcement">
			...
			<VButton slot="action-items" size="condensed" shape="pill" href="https://vivid.deno.dev" target="_blank" appearance="filled" connotation="accent" label="Start Now" icon-trailing>
				<template #icon><VIcon slot="icon" name="chevron-right-line" /></template>
			</VButton>
		</VBanner>
		<VHeader alternate>Site Header</VHeader>
		<div class="body">
			<h2>Site Content</h2>
