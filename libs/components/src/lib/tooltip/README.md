...
<template>
	<VTooltip text="Copy" placement="right">
		...
		<template #kbd-shortcut>
			<VKbdShortcut>
				<VKbdKey name="Control" appearance="outlined" size="condensed" />
				<VKbdKey name="C" appearance="outlined" size="condensed" />
			</VKbdShortcut>
		</template>
	</VTooltip>
</template>
...
<vwc-tooltip text="Copy" placement="right">
	...
	<vwc-kbd-shortcut slot="kbd-shortcut">
		<vwc-kbd-key name="Control" appearance="outlined" size="condensed"></vwc-kbd-key>
		<vwc-kbd-key name="C" appearance="outlined" size="condensed"></vwc-kbd-key>
	</vwc-kbd-shortcut>
</vwc-tooltip>
```
