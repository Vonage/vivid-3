...
<template>
	<VDatePicker helper-text="Select a date for the event to start" label="Start date" />
</template>
```
...
<template>
	<VDatePicker error-text="Please select a date for the event to start" label="Start date" />
</template>
```
...
<template>
	<VDatePicker value="2023-01-01" label="Start date" />
</template>
```
...
<template>
	<VDatePicker min="2023-06-10" label="Start date" value="2023-06-15" />
</template>
```
...
<template>
	<VDatePicker max="2023-06-20" label="Start date" value="2023-06-15" />
</template>
```
...
The `scale` attribute controls the Date Picker input element display size.
...
<template>
	<div class="container">
		<VDatePicker scale="normal" label="Normal" />
		<VDatePicker scale="condensed" label="Condensed" />
	</div>
</template>
...
```html preview 400px
<div class="container">
	<vwc-date-picker scale="normal" label="Normal"></vwc-date-picker>
	<vwc-date-picker scale="condensed" label="Condensed"></vwc-date-picker>
</div>
...
<template>
	<VDatePicker disabled label="Start date" />
</template>
```
...
<template>
	<VDatePicker readonly label="Start date" />
</template>
```
