 ...
 */
/* eslint-disable @typescript-eslint/explicit-member-accessibility, @typescript-eslint/ban-types */
...
export type InterfaceSymbol<K = any> = ( /* eslint-disable-line @typescript-eslint/no-unused-vars */
    target: any,
    property: string,
    index?: number
) => void;
...
export class ContainerImpl implements Container {
    ...
    public has<K extends Key>(key: K, searchAncestors = false): boolean {
