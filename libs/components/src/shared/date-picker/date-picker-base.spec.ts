import {
	...
	elementUpdated,
	fixture,
	listenToFormSubmission, setupDelegatesFocusPolyfill
...
describe.each([
	['vwc-date-picker'],
	['vwc-date-range-picker']])('%s', (COMPONENT_TAG) => {
	...
	beforeEach(async () => {
		element = (await fixture(`<${COMPONENT_TAG}></${COMPONENT_TAG}>`)) as DatePickerBase;
