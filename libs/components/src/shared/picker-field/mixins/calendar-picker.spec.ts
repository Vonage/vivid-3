...
import type { DateRangePicker } from '../../../lib/date-range-picker/date-range-picker';
import type { DatePicker } from '../../../lib/date-picker/date-picker';

type ComponentType = DatePicker | DateRangePicker;

/**
 * Run common tests against calendar pickers.
 */
