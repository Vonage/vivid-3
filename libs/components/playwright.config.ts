...
const config: PlaywrightTestConfig = {
	...
	webServer: {
		command: isDocker
			? `pnpm concurrently "../../scripts/start-playwright-docker.sh" "pnpm wait-on tcp:localhost:3000 && sleep 1 && pnpm turbo run @vonage/vivid#build && pnpm http-server -p ${port} ../.."`
