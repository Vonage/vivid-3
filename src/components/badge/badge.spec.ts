  ...
  describe(`icons`, function () {
    function getLeadingIconElements(actualElement: Badge) {
      const leadingIconElement =
        actualElement.shadowRoot?.querySelector(".icon--leading");
    ...
    function getTrailingIconElements(actualElement: Badge) {
      const trailingIconElement =
        actualElement.shadowRoot?.querySelector(".icon--trailing");
    ...
    it(`should have leading icon when set`, async function () {
      ...
      const { leadingIconElement, vwcIconElementLeading } =
        getLeadingIconElements(actualElement);
    ...
    it(`should have trailing icon when set`, async function () {
      ...
      const { trailingIconElement, vwcIconElementTrailing } =
